...
-- DROP TABLE IF EXISTS dds.fct_api_sales CASCADE;
-- DROP TABLE IF EXISTS dds.dm_api_delivery_details CASCADE;
-- DROP TABLE IF EXISTS dds.dm_api_couriers CASCADE;
-- DROP TABLE IF EXISTS dds.dm_api_orders CASCADE;
...
CREATE TABLE IF NOT EXISTS dds.fct_api_sales (
    ...
    CONSTRAINT fct_api_sales_delivery_id_fkey FOREIGN KEY (delivery_id) REFERENCES dds.dm_api_delivery_details(delivery_id),
    CONSTRAINT fct_api_sales_order_id_fkey FOREIGN KEY (order_id) REFERENCES dds.dm_api_orders(order_id)
);
