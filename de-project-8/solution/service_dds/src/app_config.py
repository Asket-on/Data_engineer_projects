...
class AppConfig:
    CERTIFICATE_PATH = '/crt/YandexInternalRootCA.crt'# '/usr/local/share/ca-certificates/Yandex/YandexInternalRootCA.crt'
    ...
    def __init__(self) -> None:
        ...
        # self.kafka_producer_password = "pass1234"
        # self.kafka_producer_topic = "dds-service-orders"
